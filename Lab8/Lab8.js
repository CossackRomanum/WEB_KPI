function Employee(name, lastName, baseSalary, experience){
  ...
  Employee.prototype.giveSalary  = function() {
    return document.write("<p>" +this.name + " " + this.lastName + " gets " + this.getSalary() + " USDT "+ "</p>" )
  }
  ...
  Department.prototype.giveSalary = function() {
   ...
   function main() {
      const dev = new Developer("John", "Smit", 1000, 5);
      const dev2 = new Developer("Carl", "Johnson", 1000, 1);
      const dev3 = new Developer("Phil ", "Spencer", 1200, 9);
      const dev4 = new Developer("William ", "Gates ", 1100, 9);
    const des  = new Designer("Mark ", "Mark ", 1200, 6, 0.5);
    const des1 = new Designer("Steven ", "Jobs ", 1000, 6, 0.7);
    const manager = new Manager("Elon", "Musk", 1400, 5, [dev, dev2, dev3, dev4,des,des1]);
